...
fprintf(fp, "%d,%4.10lf,%4.10lf,%d,%d,%f,%f,%d,%d\n",rtk_data.pos_llh.tow, rtk_data.pos_llh.lat, rtk_data.pos_llh.lon, rtk_data.pos_llh.flags, rtk_data.pos_llh.n_sats, rtk_data.heading_kalman, rtk_data.heading_mag, rtk_data.vel_ned_data.n, rtk_data.vel_ned_data.e);
fflush(fp);
