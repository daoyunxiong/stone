	...
	//    if(abs(gz_i) < 10) gz_i = 0;
     ...
     float heading = heading + gz * 0.02;
        ...
        case SBP_MSG_MAG_RAW: //output magnetometer heading angle
            ...
            magnetic_heading_update(rtk_data);
...
*/
  int mx_i = data.mag_data_raw.mag_x - MAGNETOMETER_ORIGIN_X;
  int my_i = data.mag_data_raw.mag_y - MAGNETOMETER_ORIGIN_Y;
  int mz_i = data.mag_data_raw.mag_z - MAGNETOMETER_ORIGIN_Z;
